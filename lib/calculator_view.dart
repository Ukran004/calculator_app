...
class _CalculatorViewState extends State<CalculatorView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ukran Calculator App'),
      ),
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              Text(history,style: TextStyle(fontSize: 16,color: const Color.fromARGB(115, 92, 160, 104)),),
              TextFormField(
                  ...
                  itemBuilder: (context, index) {
                    return ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor:operationList.contains(lstSymbols[index])?const Color.fromARGB(255, 80, 145, 87): const Color.fromARGB(255, 111, 80, 80),
